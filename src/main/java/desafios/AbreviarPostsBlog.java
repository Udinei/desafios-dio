...
/**
 * Desafio - Abreviando posts do blog
 ...
 * que inicia com tal letra e que aparece no post. Uma vez escolhida a palavra, sempre que ela aparecer no post, ela será substituída por sua letra inicial e um ponto, diminuindo assim o número de caracteres impressos na tela.
 *
 ...
 *
 * Leonardo precisa que seu post tenha o menor número de caracteres possíveis, e por isso pediu a sua ajuda. Para
 * cada letra, escolha uma palavra, de modo que ao serem aplicadas todas as abreviações, o texto contenha o menor
 * número de caracteres possíveis.
 *
 * Entrada
 ...
 *
 * Em seguida, imprima um inteiro N, indicando o número de palavras em que foram escolhidas uma letra para
 * a abreviação no texto. Nas próximas N linhas, imprima o seguinte padrão “C. = P”, onde C é a letra inicial
 * e P é a palavra escolhida para tal letra. As linhas devem ser impressas em ordem crescente da letra inicial.
 *
 *
 * Exemplo de Entrada
 * abcdef abc abc abc
 ...
 * a. = abcdef
 *
 * Outro exemplos de entradas e saidas
 *
 * ID no URI:
 * Entradas:
 * 1)
 ...
 * 2)
  ...
  .
 * */
public class AbreviarPostsBlog {
